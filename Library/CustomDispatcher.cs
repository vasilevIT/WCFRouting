...
namespace Library
{
    ...
    public class SimpleMessageInspector : IClientMessageInspector, IDispatchMessageInspector
    {
        ...
        private Message TransformMessage(Message oldMessage)
        {
            ...
            Console.WriteLine("OldMessage: " + newMessage.ToString());
            return newMessage;
        }
        ...
        private Message TransformMessage2(Message oldMessage)
        {
            ...
            XmlNode node = xdoc.SelectSingleNode("//a:TTL", nsmgr);
            if (node != null) node.InnerText = (Int32.Parse(node.InnerText) - 1).ToString();
